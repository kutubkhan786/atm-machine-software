	    ...
	    try
	     {
		    ...
		    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/atmdb","root","Killer@72@174");
		    System.out.println("Connected to database.");
            ps=con.prepareStatement("select * from accountdetail where atmno='"+t1.getText()+"' and pinno='"+pwd.getPassword()+"'");
	        rs=ps.executeQuery();
		    while(rs.next())
	        {
